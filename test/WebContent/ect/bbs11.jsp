...
<link href="/resource/css/bbs.css" rel="stylesheet">
...
function open11(key){
	...
	$.ajax({
		...
		url: url,
		success: function(res){
			//view.jsp페이지로 이동해야하고, res의 정보들을 그 페이지로 넘겨주어야함. (post로)
			
			//test
			//alert(res.title);
			
			//get방식
			window.location.href = "/view.jsp?title="+res.title+"&contents="+res.contents+"&date="+res.date;
...
/* 			window.location.href="/view.jsp"
			...
			html+= "<br><br>";
			html+= "<span id=\"date\">"+res.date+"</span>";
			html+= "<br><br>";
			html+= "내용 : <div id=\"contents\">"+res.contents+"</div>";
			html+= "<br><br>";
